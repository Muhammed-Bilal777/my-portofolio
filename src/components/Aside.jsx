    ...
    <aside className="sidebar">
      <div className="sidebar-info">
        <figure className="avatar-box">
          <img src={image} alt="Muhammed Bilal" width="80" />
        </figure>
      ...
      <div className="sidebar-info_more">
        ...
        <ul className="contacts-list">
          <li className="contact-item">
            ...
            <div className="contact-info">
              ...
              <a
                href="https://drive.google.com/file/d/1pqju5ZARl5BSb8TyyZvy2mKDHJnQKCNd/view"
                target="_blank"
        ...
        <ul className="social-list">
          <li className="social-item">
            <a
              href="https://www.instagram.com/muhammed_bilal_07_/"
          ...
          <li className="social-item">
            <a
              href="https://in.linkedin.com/in/muhammed-bilal-409343218"
              target="_blank"
              className="social-link"
            >
